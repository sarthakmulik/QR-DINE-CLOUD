...
function LoginContent() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Full page navigation so middleware picks up session cookies
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 to-orange-100 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">QR Dine Cloud</h1>
          <p className="text-gray-500 mt-1">Restaurant Order Management</p>
        </div>
