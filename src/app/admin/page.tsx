              ...
              <tr key={hotel.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  <select
                    ...
                    className="bg-transparent border border-gray-200 rounded px-2 py-1 text-xs font-semibold focus:outline-none focus:ring-1 focus:ring-brand-500"
                  >
                ...
                <td className="px-4 py-3">{formatDate(hotel.lastPaymentDate)}</td>
                <td className="px-4 py-3">{formatDate(hotel.nextDueDate)}</td>
                <td className="px-4 py-3">{formatINR(hotel.billingAmount)}</td>
                <td className="px-4 py-3">
