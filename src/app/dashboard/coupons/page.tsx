    ...
    <div className="space-y-6 animate-page-entrance">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm">Create and manage discounts for your restaurant</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isSkeletons ? (
          [...Array(3)].map((_, i) => (
            <div key={i} className="bg-white dark:bg-[#18181b] border dark:border-white/[0.07] rounded-2xl p-5 shadow-sm h-48 animate-pulse flex flex-col justify-between">
              <div>
                <div className="h-6 w-24 bg-gray-200 dark:bg-white/[0.06] rounded" />
              ...
              <div className="mt-6 pt-4 border dark:border-white/[0.07]-t flex justify-between items-center">
                <div className="h-6 w-16 bg-gray-200 dark:bg-white/[0.06] rounded-full" />
                <div className="h-6 w-12 bg-gray-200 dark:bg-white/[0.06] rounded" />
              </div>
            </div>
          ))
        ) : (
          coupons.map((coupon) => (
            <div
              key={coupon.id}
              className={`bg-white dark:bg-[#18181b] border dark:border-white/[0.07] rounded-2xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between relative overflow-hidden ${
            ...
            >
              ...
              <div className="mt-6 pt-4 border dark:border-white/[0.07]-t flex items-center justify-between">
                <button
                  ...
                  className={`text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wider transition-all disabled:opacity-50 ${
                    coupon.is_active
                      ? "bg-green-50 text-green-700 border border dark:border-white/[0.07]-green-200 hover:bg-green-100"
                      : "bg-slate-100 text-slate-500 border border dark:border-white/[0.07]-slate-200 hover:bg-slate-200"
                  }`}
                >
        ...
        {!isSkeletons && coupons.length === 0 && (
          <div className="col-span-full flex flex-col items-center justify-center text-center py-16 bg-slate-50 border dark:border-white/[0.07] border dark:border-white/[0.07]-dashed rounded-2xl text-gray-400 dark:text-gray-500">
            <Tag size={40} className="opacity-30 mb-3" />
            <p className="font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm">No coupon codes yet</p>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Create your first promo code to drive more orders</p>
          </div>
        )}
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border dark:border-white/[0.07] rounded-lg px-3 py-2 uppercase font-black"
              required
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded border dark:border-white/[0.07]-gray-300 dark:border dark:border-white/[0.07]-white/[0.08] text-brand-600 focus:ring-brand-500"
            />
