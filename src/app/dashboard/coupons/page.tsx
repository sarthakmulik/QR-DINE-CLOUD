    ...
    <div className="space-y-6 animate-page-entrance">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 dark:text-zinc-400 dark:text-zinc-500 text-sm">Create and manage discounts for your restaurant</p>
        </div>
            ...
            <div key={i} className="bg-white dark:bg-zinc-900 border rounded-2xl p-5 shadow-sm h-48 animate-pulse flex flex-col justify-between">
              <div>
                ...
                <div className="mt-4 space-y-1.5">
                  <div className="h-7 w-20 bg-gray-200 dark:bg-zinc-800/70 rounded" />
            ...
            >
              ...
              <div>
                ...
                <div className="mt-4 space-y-1.5">
                  ...
                  <p className="text-xs text-gray-500 dark:text-zinc-400 dark:text-zinc-500 font-medium">
              ...
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-zinc-800 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  className="p-1 text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:text-zinc-400 dark:text-zinc-500 transition"
                    title="Edit coupon"
                  >
                    <Pencil size={16} />
                  </button>
