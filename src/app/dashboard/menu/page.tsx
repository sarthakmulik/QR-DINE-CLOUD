...
export default function MenuPage() {
  ...
  return (
    <div className="space-y-6 animate-page-entrance">
      ...
      {limitReached && (
        <div className="bg-amber-50 border border dark:border-white/[0.07]-amber-200 rounded-xl p-4 flex items-start gap-3 text-amber-800 text-sm animate-fade-in shadow-sm">
      ...
      {categories.length === 0 ? (
        <div className="bg-white dark:bg-[#16161A] rounded-3xl border dark:border-white/[0.07] border dark:border-white/[0.07]-dashed border dark:border-white/[0.07]-slate-300 dark:border dark:border-white/[0.07]-white/10 py-24 flex flex-col items-center justify-center text-center px-4 transition-colors duration-200">
        ...
        <div className="space-y-8">
          {categories.map((category) => (
            <div key={category.id} className="bg-white dark:bg-[#16161A] border border dark:border-white/[0.07]-slate-200 dark:border dark:border-white/[0.07]-white/5 rounded-[1.5rem] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] overflow-hidden group/cat transition-colors duration-200">
              <div className="flex justify-between items-center p-5 bg-slate-50/50 dark:bg-white/[0.02] border dark:border-white/[0.07]-b border dark:border-white/[0.07]-slate-100 dark:border dark:border-white/[0.07]-white/5">
              ...
              <div className="p-5">
                {(!category.items || category.items.length === 0) ? (
                  <div className="text-center py-8 text-slate-400 dark:text-slate-500 border dark:border-white/[0.07]-2 border dark:border-white/[0.07]-dashed border dark:border-white/[0.07]-slate-100 dark:border dark:border-white/[0.07]-white/5 rounded-xl">
                  ...
                  <div className="flex flex-col gap-3">
                    {category.items.map((item) => (
                      <div
                        key={item.id}
                        className={`flex items-center justify-between p-4 border border dark:border-white/[0.07]-slate-100 dark:border dark:border-white/[0.07]-white/5 rounded-2xl group transition-all duration-300 hover:border dark:border-white/[0.07]-slate-200 dark:hover:border dark:border-white/[0.07]-white/10 ${
                      ...
                      >
                        ...
                        <div className="flex items-center gap-6 shrink-0 pl-4 border dark:border-white/[0.07]-l border dark:border-white/[0.07]-slate-100 dark:border dark:border-white/[0.07]-white/5 ml-4">
                          <div className="flex items-center gap-3">
                            ...
                            >
                              <div className={`w-4 h-4 bg-white dark:bg-[#18181b] rounded-full absolute top-0.5 transition-all shadow-sm ${item.isAvailable ? 'left-5' : 'left-0.5'}`} />
                            </button>
                          </div>
        ...
        <form onSubmit={addCategory} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border dark:border-white/[0.07]-slate-300 shadow-sm focus:border dark:border-white/[0.07]-brand-500 focus:ring-brand-500 h-11"
        ...
        <form onSubmit={saveItem} className="space-y-5 max-h-[70vh] overflow-y-auto px-1 custom-scrollbar">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border dark:border-white/[0.07]-slate-300 shadow-sm focus:border dark:border-white/[0.07]-brand-500 focus:ring-brand-500"
              rows={2}
            />
          </div>
          ...
          <div>
            ...
            {itemForm.imageUrl ? (
              <div className="relative w-full h-40 bg-slate-100 rounded-xl overflow-hidden border border dark:border-white/[0.07]-slate-200">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
              ...
              <div>
                <input
                  ...
                  disabled={saving}
                  className="block w-full text-sm text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border dark:border-white/[0.07]-0 file:text-sm file:font-bold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100 transition-all cursor-pointer"
                />
                {imageError && (
                  <p className="text-red-500 text-xs mt-2 font-medium bg-red-50 p-2 rounded-lg border border dark:border-white/[0.07]-red-100">{imageError}</p>
                )}
          ...
          <div className="border dark:border-white/[0.07]-t border dark:border-white/[0.07]-slate-100 p-4 space-y-4 bg-slate-50/50 rounded-xl mt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-brand-600 border dark:border-white/[0.07]-slate-300 rounded focus:ring-brand-500 cursor-pointer"
                />
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-emerald-600 border dark:border-white/[0.07]-slate-300 rounded focus:ring-emerald-500 cursor-pointer"
                />
                <label htmlFor="isVegetarian" className="text-sm font-bold text-slate-700 cursor-pointer flex items-center gap-1 select-none">
                  <span className="w-3 h-3 border border dark:border-white/[0.07]-emerald-600 rounded flex items-center justify-center"><div className="w-1.5 h-1.5 rounded-full bg-emerald-600"></div></span>
                  Vegetarian
                </label>
              </div>
            ...
            {/* Spice Level */}
            <div className="space-y-2 pt-2 border dark:border-white/[0.07]-t border dark:border-white/[0.07]-slate-200">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`py-2 px-1 text-[10px] text-center font-bold rounded-xl border dark:border-white/[0.07] transition-all ${
                      itemForm.spicyLevel === opt.level
                        ? "bg-brand-50 border dark:border-white/[0.07]-brand-500 text-brand-700 shadow-sm"
                        : "bg-white dark:bg-[#18181b] border dark:border-white/[0.07]-slate-200 text-slate-600 hover:bg-slate-50"
                    }`}
                  >
                    {opt.label}
                  </button>
          ...
          <div className="flex justify-end gap-3 pt-4 border dark:border-white/[0.07]-t border dark:border-white/[0.07]-slate-100">
            <Button
              type="button"
              variant="secondary"
