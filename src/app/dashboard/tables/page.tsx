...
export default function TablesPage() {
  ...
  if (serviceType === "quick_service") {
    return (
      <div className="space-y-6 animate-page-entrance">
        ...
        <div className="bg-white dark:bg-[#18181b] rounded-2xl p-8 shadow-sm border border dark:border-white/[0.07]-slate-200 flex flex-col items-center justify-center max-w-lg mx-auto mt-10">
          <div className="bg-slate-50 p-6 rounded-xl border border dark:border-white/[0.07]-slate-100 mb-6">
            {genericQrCode ? (
          ...
          <div className="mt-6 w-full pt-6 border dark:border-white/[0.07]-t border dark:border-white/[0.07]-slate-100 flex justify-between items-center">
             <div>
  ...
  return (
    <div className="space-y-6 animate-page-entrance">
      ...
      {limitReached && (
        <div className="bg-amber-50 border border dark:border-white/[0.07]-amber-200 rounded-xl p-4 flex items-start gap-3 text-amber-800 text-sm animate-fade-in">
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {isSkeletons ? (
          Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="bg-white dark:bg-[#18181b] rounded-2xl p-5 shadow-sm border border dark:border-white/[0.07]-slate-200 animate-pulse">
          ...
          tables.map((table) => (
            <div
              key={table.id}
              className="bg-white dark:bg-[#18181b] rounded-2xl p-5 shadow-sm border border dark:border-white/[0.07]-slate-200 hover:shadow-md transition-all duration-300 group flex flex-col h-full relative overflow-hidden"
            >
              ...
              <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 rounded-xl p-4 mb-4 border border dark:border-white/[0.07]-slate-100 relative group/qr">
          ...
          <div className="col-span-full bg-white dark:bg-[#18181b] rounded-3xl border dark:border-white/[0.07] border dark:border-white/[0.07]-dashed border dark:border-white/[0.07]-slate-300 py-20 flex flex-col items-center justify-center text-center px-4">
